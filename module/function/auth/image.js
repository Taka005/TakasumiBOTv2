module.exports = async(interaction)=>{
  ...
  if(interaction.customId.startsWith("image_")){
    ...
    const keys = [
      ...
      {text:"G4sveS",url:"https://cdn.taka.cf/images/auth/img_3.png"},
      {text:"3dgHR",url:"https://cdn.taka.cf/images/auth/img_4.png"},
      {text:"ascA23",url:"https://cdn.taka.cf/images/auth/img_5.png"},
      {text:"Cd2d4s",url:"https://cdn.taka.cf/images/auth/img_6.png"},
      {text:"Mgfn4",url:"https://cdn.taka.cf/images/auth/img_7.png"},
      {text:"Hsdgs1",url:"https://cdn.taka.cf/images/auth/img_8.png"}
    ];
