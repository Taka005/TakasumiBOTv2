...
const markov = new Markov(50);
markov.train([
  "嘘は嘘であると見抜ける人でないと(Discordを使うのは)難しい",
  "嘘を嘘と見抜けない人は、インターネットを使うのは難しいでしょう",
  "「写像」？なんすか「写像」って...",
  ...
  "へぇー...",
  "それってあなたの想像ですよね？",
  "僕は子供ができたときには「Discordを見せない」というフィルタリングをするのではなく、「Discordを見せても大丈夫な教育」をしたいと思っています",
...
module.exports = async(message)=>{
  ...
  if(rate(false,true,0.01)){
    ...
    if(Object.keys(reply_1).find(key=>message.content.match(key))){
      ...
      content = markov.isLoad ? await markov.make() : "なんかそういうデータあるんですか？";
    }
